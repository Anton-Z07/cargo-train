...
class Settings extends CActiveRecord
{
	...
	public static function checkStayingWeight($time, $weight)
	{
		$a = Settings::GetDecoded('staying_weight');
		if (is_array($a)) foreach ($a as $s) {
			if ($time <= $s->time && $weight > $s->weight) return false;
		}
		return true;
	}
}
