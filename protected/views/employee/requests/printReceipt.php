...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Дорожная ведомость</title>
	...
	<body>
		...
		$labels = [
			[47, 152, 60, $request->shipping->railcar->getTypeShort()],
			[140, 152, 100, $request->shipping->railcar->number],
			[260, 152, 100, round($request->shipping->railcar->capacity/1000).'т'],
			[330, 152, 100, $request->shipping->railcar->volume.'м³'],
