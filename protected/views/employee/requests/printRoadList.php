...
<html>
	...
	<body>
		...
		$labels = [
			...
			[676, 889, 100, $request->getTotalCost()],
			[608, 926, 90, $conductor_count],
			[670, 907, 90, $request->shipping->conductor1],
			[670, 942, 90, $request->shipping->conductor2],
			[676, 980, 100, $request->getTotalCost()],
		];
